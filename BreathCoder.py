...
    app.run(host='0.0.0.0', port=port)   i have this in our backend but the judges asked us that what is the validation of methodology behind the expalinable ai that we have used and sceintific reason of microphone that we have used also asked the range of it 